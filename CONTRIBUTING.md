## Contributing to Ethernet_Manager
...
```
xy@xy-Inspiron-3593:~$ cd Arduino/xy/Ethernet_Manager_GitHub/
xy@xy-Inspiron-3593:~/Arduino/xy/Ethernet_Manager_GitHub$
```

2. Issue astyle command

```
xy@xy-Inspiron-3593:~/Arduino/xy/Ethernet_Manager_GitHub$ bash utils/restyle.sh
```
